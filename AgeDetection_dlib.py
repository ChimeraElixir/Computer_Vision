...
age_weights = "./assets/age_deploy.prototxt"
age_config = "./assets/age_net.caffemodel"
...
while True:
    ...
    if not faces:
        ...
        cv2.putText(frame, f"{mssg}", (40, 40), cv2.FONT_HERSHEY_SIMPLEX, 2, (200), 2)
    else:
        # --------- Bounding Face ---------#
        for face in faces:
    ...
    # Single imshow outside the if/else block
